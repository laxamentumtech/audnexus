...
export const B08G9PRS1K = AudibleProductSchema.parse({
	product: {
		...
		product_images: {
			'1024': 'https://m.media-amazon.com/images/I/81Nzlrfud+L._SL1024_.jpg',
