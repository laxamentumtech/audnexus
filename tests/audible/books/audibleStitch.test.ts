...
describe('When stitching together Scorcerers Stone from Audible', () => {
    ...
    it('returned description', () => {
        expect(response.description).toBe('Harry Potter has never even heard of Hogwarts when the letters start dropping on the doormat at number four, Privet Drive. Addressed in green ink on yellowish parchment with a purple seal, they are swiftly confiscated by his grisly aunt and uncle....')
    })
